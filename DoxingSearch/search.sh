...
printf "\e[1;77m ██████╔╝╚██████╔╝██╔╝ ██╗███████║███████╗██║  ██║██║  ██║╚██████╗██║  ██║\e[0m\e[1;92m\n"
printf "\e[1;77m ╚═════╝  ╚═════╝ ╚═╝  ╚═╝╚══════╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝\e[0m\e[1;92m\n"
printf "                   \e[1;92mv1.0, Modified:SmoshHaxx <-- OldName \e[0m   \e[1;92m\n"
...
check_youtube=$(curl -s "https://www.youtube.com/results?search_query=$username" -L -H "Accept-Language: en" | grep -o 'Not Found'; echo $?)


if [[ $check_youtube == *'1'* ]]; then
printf "\e[1;92m Found!\e[0m https://www.youtube.com/results?search_query=%s\n" $username
